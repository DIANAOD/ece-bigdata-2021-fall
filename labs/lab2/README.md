...
1. Create a directory named after your username in your group HDFS directory. E.g. `/education/ece_2021_fall_bda_1/$USER`
...
1. Look at the content of the input directory we will use: `/education/ece_2021_fall_bda_1/resources/lab2`
2. Run the command:
   ```sh
   yarn jar /usr/hdp/current/hadoop-mapreduce-client/hadoop-mapreduce-examples-3.1.1.3.1.0.0-78.jar \
    wordcount /education/ece_2021_fall_bda_1/resources/lab2 \
    /education/ece_2021_fall_bda_1/$USER/lab2/output-moby-dick
   ```
