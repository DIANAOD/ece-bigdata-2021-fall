...
2. Check that your table was created using the HDFS CLI at `/warehouse/tablespace/managed/hive/ece_2021_fall_bda_1.db/$USER_nyc_drivers` (should be empty)
...
3. Check what the data looks like in the managed table using the HDFS CLI at `/warehouse/tablespace/managed/hive/ece_2021_fall_bda_1.db/$USER_nyc_drivers`
